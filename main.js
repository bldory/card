 ...
 */
 ...
 rare.addEventListener('input', function() {
     ...
     if(rare.value == 2) {
         ...
         rarity.style.background = "linear-gradient(90deg, rgba(154,255,46,1) 0%, rgba(0,166,255,1) 100%)";
     }
     if(rare.value == 3) {
     ...
     if(rare.value == 4) {
         ...
         rarity.style.background = "linear-gradient(90deg, rgba(255,0,0,1) 0%, rgba(255,191,46,1) 100%)";
     }
     if(rare.value == 5) {
